...
/* $Id: executor.c,v 1.1.1.1 2003/04/07 23:26:49 anonymous Exp $ */
#include <fftw-int.h>
#include <stdio.h>
#include <stdlib.h>

const char *fftw_version = "FFTW V" FFTW_VERSION " ($Id: executor.c,v 1.1.1.1 2003/04/07 23:26:49 anonymous Exp $)";
